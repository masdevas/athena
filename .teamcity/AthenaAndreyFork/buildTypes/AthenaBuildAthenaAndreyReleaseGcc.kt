...
object AthenaBuildAthenaAndreyReleaseGcc : BuildType({
    name = "[Release][GCC] Build"

    artifactRules = "+:build_Release_GCC/athena*.tar.gz"
    ...
    params {
        ...
        param("env.ATHENA_BINARY_DIR", "%teamcity.build.checkoutDir%/install_Release_GCC")
        param("env.BUILD_PATH", "%teamcity.build.checkoutDir%/build_Release_GCC")
    }
    ...
    steps {
        exec {
            ...
            arguments = "--ninja --build-type Release --install-dir=%env.ATHENA_BINARY_DIR%  --build-type Release %env.BUILD_PATH% %env.SRC_DIR%"
    ...
    features {
        ...
        feature {
            ...
            param("xmlReportParsing.reportDirs", "+:build_Release_GCC/Testing/**/*.xml")
        }
    }
