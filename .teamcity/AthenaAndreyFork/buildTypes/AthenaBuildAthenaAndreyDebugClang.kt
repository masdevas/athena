...
object AthenaBuildAthenaAndreyDebugClang : BuildType({
    name = "[Debug][Clang] Build"
    ...
    params {
        ...
        param("env.ATHENA_BINARY_DIR", "%teamcity.build.checkoutDir%/install_Debug_Clang")
        param("env.BUILD_PATH", "%teamcity.build.checkoutDir%/build_Debug_Clang")
    }
    ...
    steps {
        exec {
            ...
            arguments = "--ninja --build-type Debug --install-dir=%env.ATHENA_BINARY_DIR%  --use-ldd --build-type Debug %env.BUILD_PATH% %env.SRC_DIR%"
    ...
    features {
        ...
        feature {
            ...
            param("xmlReportParsing.reportDirs", "+:build_Debug_Clang/Testing/**/*.xml")
        }
    }
