...
NodeInternal::NodeInternal(utils::SharedPtr<ContextInternal> context, utils::Index publicNodeIndex,
    utils::Index operationIndex, utils::String name)
    : AbstractNodeInternal(std::move(context), publicNodeIndex, std::move(name)), mOperationIndex(operationIndex) {}
