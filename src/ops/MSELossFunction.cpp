...
core::inner::Tensor*
MSELossFunction::getDerivativeTensor(core::Context& context,
...
void MSELossFunction::genDerivative(
  ...
  default:
    new core::FatalError(core::ATH_NOT_IMPLEMENTED, "Data type not supported");
  }
...
core::inner::Tensor*
MSELossFunction::getErrorTensor(core::Context& context,
                                std::vector<core::inner::Tensor*> args,
...
std::string MSELossFunction::serialize() const { return ""; }
} // namespace athena::ops
