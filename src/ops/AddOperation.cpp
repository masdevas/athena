...
void AddOperation::gen(core::AbstractGenerator &g, std::stack<core::Tensor *> &operationArguments) const {
...
core::Tensor *AddOperation::getResultSize(std::deque<core::Tensor *> args) const {
