...
//  auto* tensor =
//      new
//      proto_graph::Tensor(serializeTensor(inner::getTensorFromNode(node)));
...
//}
// static void serializeLossNode(proto_graph::LossNode* lossNode, LossNode&
// node) {
...
//    InputNodeImpl n(getShape(node.tensor()),
//    protoToNativeDataType(node.tensor()),
