...
static void processTensor(core::inner::Tensor& tensor, TensorType type,
                          std::ostream& stream) {
...
static void
processActionNode(core::Context* mContext, core::Node& actionNode,
...
static void
processLossNode(core::Context* mContext, core::LossNode& lossNode,
...
static void
processOutputNode(core::Context* mContext, core::OutputNode& outputNode,
