...
#ifdef DEBUG
  if (!mString) {
    FatalError(ATH_BAD_ACCESS, "String ", this, " getting isn't completed. String pointer is nullptr.");
  }
#endif
...
#ifdef DEBUG
  if (!mString) {
    FatalError(ATH_BAD_ACCESS, "String ", this, " getting size isn't completed. String pointer is nullptr.");
  }
#endif
