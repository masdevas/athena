...
#ifndef ATHENA_COMBINATIONOPERATION_H
#define ATHENA_COMBINATIONOPERATION_H
...
class ATH_OPERATION_EXPORT CombineOperation : public core::Operation {
public:
...
#endif // ATHENA_COMBINATIONOPERATION_H
