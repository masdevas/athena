...
class ATH_OPERATION_EXPORT AddOperationInternal : public core::internal::OperationInternal {
public:
  AddOperationInternal(utils::SharedPtr<core::internal::ContextInternal> context, utils::Index publicNodeIndex, utils::String name = utils::String(""));
