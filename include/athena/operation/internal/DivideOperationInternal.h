...
#ifndef ATHENA_DIVIDEOPERATIONINTERNAL_H
#define ATHENA_DIVIDEOPERATIONINTERNAL_H
...
class ATH_OPERATION_EXPORT DivideOperationInternal
...
#endif // ATHENA_DIVIDEOPERATIONINTERNAL_H
