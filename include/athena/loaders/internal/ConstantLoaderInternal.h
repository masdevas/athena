...
class ATH_LOADERS_EXPORT ConstantLoaderInternal : public core::internal::AbstractLoaderInternal {
public:
  ConstantLoaderInternal(utils::WeakPtr<core::internal::ContextInternal> context, utils::Index publicIndex, double value, utils::String name = utils::String(""));
protected:
  double mValue;
};
} // namespace athena::loaders::internal
