...
public:
  InputNodeInternal(utils::SharedPtr<ContextInternal> context, utils::Index publicNodeIndex,
                    TensorShape tensorShape, DataType dataType, bool isFrozen,
                    utils::Index loaderIndex, utils::String name = utils::String(""));
