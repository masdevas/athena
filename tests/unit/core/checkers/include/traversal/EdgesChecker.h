...
struct Edge {
  ...
  utils::Index endNode{};
  size_t mark{};
  Edge(utils::Index startNode, utils::Index endNode, size_t mark) : startNode(startNode), endNode(endNode), mark(mark) {}
  bool operator==(const Edge& rhs) const {
    return startNode == rhs.startNode && endNode == rhs.endNode && mark == rhs.mark;
  }
  bool operator<(const Edge& rhs) const {
