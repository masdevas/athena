...
TEST(JIT, DISABLED_LinReg) {
  ...
  //  InputNodeImpl inputInp(shape, DataType::FLOAT, inputLoader, context,
  //  false, "a"); InputNodeImpl weightsInp(shape2, DataType::FLOAT,
  //  weightsLoader, context, false,
  //                       "b");
  ...
  //  InputNodeImpl cInp(shapeScalar, DataType::FLOAT, targetLoader, context,
  //  true,
  //                 "c");
  //  graph.addNode(cInp);
