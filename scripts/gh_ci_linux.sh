...
export COMMAND_WRAPPER="docker run -v $GITHUB_WORKSPACE:$GITHUB_WORKSPACE -e ATHENA_TEST_ENVIRONMENT=ci -e ATHENA_BINARY_DIR=$GITHUB_WORKSPACE/install_$BUILD_TYPE -e CC=clang -e CXX=clang++ athenaml/build:llvm10"
